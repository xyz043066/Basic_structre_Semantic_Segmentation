...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', required=False, default='F:\数据集\ISPRS2D_Potsdam_Vahingen\Vahingen\Small_size\Size_256\\train\images\\', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--optimizer_name', type=str, default='sgd', help='choose the optimizer')
