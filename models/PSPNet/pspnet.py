...
from models.PSPNet.mobilenetv2 import mobilenetv2
from models.PSPNet.resnet import resnet50
...
class PSPNet(nn.Module):
    def __init__(self, num_classes, downsample_factor=8, backbone="resnet-50", pretrained=True, aux_branch=False):
