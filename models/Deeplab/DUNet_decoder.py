...
class Decoder(nn.Module):
    def __init__(self, num_classes, backbone, BatchNorm):
        ...
        self.AttentionFusionModule1 = AttentionFusionModule(in_channels=low_level_inplanes_2, out_channels=low_level_inplanes_1)
        self.AttentionFusionModule2 = AttentionFusionModule(in_channels=low_level_inplanes_1, out_channels=num_classes)
    ...
    def forward(self, x, low_level_feat_1, low_level_feat_2):
        ...
        # x = self.convblock(x)
        x = self.AttentionFusionModule1(x, low_level_feat_2)
        x = self.AttentionFusionModule2(x, low_level_feat_1)
